            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="passportTab">
                        ...
                        @if ($model->type == 0)
                            <button type="button" class="btn btn-success confirm-driver" data-bs-toggle="modal" data-bs-target="#standard-modal" data-id="{{ $model->id }}" style="float: right; margin-bottom: 5px;">{{ translate('Confirm as a driver') }}</button>
                        @endif
                        ...
                        <table class="table table-striped table-bordered dt-responsive nowrap">
                            ...
                            <tbody>
                                @if (isset($model) && isset($model->personalInfo->passport_serial_number))
                                    <tr>
                                        <th>{{ translate('Serial number') }}</th>
                                        <td>
                                            {{ $model->personalInfo->passport_serial_number ?? '' }}
                                        </td>
                                    </tr>
                                    {{-- <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $model->personalInfo->passport_issued_by ?? '' }}</td>
                                    </tr>
                                    <tr>
                                        <th>{{ translate('Passport image') }}</th>
                                        <td>{{ $model->personalInfo->passport_images ?? '' }}</td>
                                    </tr>
                                    <tr>
                                        <th>{{ translate('Passport expired date') }}</th>
                                        <td>{{ date('d.m.Y H:i', strtotime($model->personalInfo->passport_expired_date)) ?? '' }}</td>
                                    </tr>
                                @else
                                    <tr>
                                        <th colspan="2">
                                            <center>
                                                {{ translate("Passport information not found") }}
                                            </center>
                                        </th>
                                    </tr>
                                @endif
                                @if (isset($driver))
                                    <tr>
                                        ...
                                        <td>{{ $model->driver->license_number ?? '' }}</td>
                                    </tr>
                                    <tr>
                                        <th>{{ translate('License expired date') }}</th>
                                        <td>{{ date('d.m.Y H:i', strtotime($model->driver->license_expired_date)) ?? '' }}</td>
                                    </tr>
                                    <tr>
                                        <th>{{ translate('License image') }}</th>
                                        {{-- <td><img src="/uploads"></td> --}}
                                        <td>{{ $model->driver->license_image ?? '' }}</td>
                                    </tr>
                                @else
                                    <tr>
                                        <th colspan="2">
                                            <center>
                                                {{ translate("Driver's license information not found") }}
                                            </center>
                                        </th>
                                    </tr>
                                @endif
                    ...
                    <div class="tab-pane overflow-scroll" id="ordersTab">
                        ...
                        <div style="overflow: scroll; max-height: 80vh; min-width: 910px;">

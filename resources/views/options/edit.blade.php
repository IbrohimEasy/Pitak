...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <form action="{{route('option.update', $model->id)}}" class="parsley-examples" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="mb-3 col-4">
                        ...
                        <input type="file" class="form-control" name="icon" value="{{$model->icon}}"/>
                    </div>
                    <div class="mb-3 col-4">

                ...
                @foreach ($model as $val)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- <a href="{{ route('order.destroy', $val->id) }}"> --}}
                                {{-- <button type="button" class="btn btn-danger waves-effect waves-light"><i class="fe-trash-2"></i></button> --}}
                                <button type="button" class="btn btn-danger delete-order" data-bs-toggle="modal" data-bs-target="#warning-alert-modal" data-url="{{ route('order.destroy', $val->id) }}"><i class="fe-trash-2"></i></button>
                            {{-- </a> --}}
                        </td>
                    </tr>
                @endforeach

                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-around">
                                <a class="form_functions btn btn-info" href="{{route('class-list.edit', 1)}}"><i class="fe-edit-2"></i></a>
                                <a class="form_functions btn btn-info" href="{{route('class-list.show', 1)}}"><i class="fe-eye"></i></a>
